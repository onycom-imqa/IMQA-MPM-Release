...
#ifndef IMQAMPMAGENT_SWIFT_H
#define IMQAMPMAGENT_SWIFT_H
...
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull blacklistUrls;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull whitelistUrls;
...
- (void)endScreen:(NSString * _Nonnull)screenName;
- (void)startComponent:(NSString * _Nonnull)component :(BOOL)parent;
- (void)endComponent:(NSString * _Nonnull)component :(BOOL)parent;
@end
