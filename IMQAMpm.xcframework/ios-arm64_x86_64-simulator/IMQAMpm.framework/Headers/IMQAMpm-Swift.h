...
#ifndef IMQAMPM_SWIFT_H
#define IMQAMPM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IMQAMpm",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7IMQAMpm12FrameCounter")
...
SWIFT_CLASS("_TtC7IMQAMpm12FrameMonitor")
...
SWIFT_CLASS("_TtC7IMQAMpm9HTTPModel")
@interface HTTPModel : NSObject
@property (nonatomic) int64_t dateKey;
...
SWIFT_CLASS("_TtC7IMQAMpm10IMQAConfig")
...
@property (nonatomic) int64_t launch_time;
...
SWIFT_CLASS("_TtC7IMQAMpm7IMQAMpm")
@interface IMQAMpm : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) IMQAMpm * _Nonnull sharedInstance;)
...
SWIFT_CLASS("_TtC7IMQAMpm16NetworkCollector")
...
SWIFT_CLASS("_TtC7IMQAMpm15NetworkProtocol")
...
SWIFT_CLASS("_TtC7IMQAMpm18ThreadTraceMonitor")
@interface ThreadTraceMonitor : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface UIViewController (SWIFT_EXTENSION(IMQAMpm))
